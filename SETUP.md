...
3. **AdsPower** приложение установлено и запущено
4. **Прокси** добавлены в AdsPower

## 🔧 Установка

### 1. Проверьте Python и pip
```bash
...
### 2. Если pip не установлен
```bash
# Windows (если pip отсутствует)
python -m ensurepip --upgrade

# Linux/Mac (если pip отсутствует)
...
# Если ошибка "pip не является внутренней или внешней командой"
# Добавьте Python в PATH или используйте:
python -m pip install -r requirements.txt

# Если ошибка прав доступа (Windows)
pip install --user -r requirements.txt

# Если ошибка прав доступа (Linux/Mac)
...
```bash
# Если requests не устанавливается
pip install --upgrade requests

# Если selenium не устанавливается  
pip install --upgrade selenium

# Если playwright не устанавливается
