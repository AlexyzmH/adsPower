...
LAST_NAMES = [
    "Al-Zayed",      # для карты 1
    "Al-Mahmoud",    # для карты 2
    "Al-Rashid",     # для карты 3
    "Al-Zahra",      # для карты 4
    "Al-Mansouri",   # для карты 5
    "Al-Sabah",      # для карты 6
    "Al-Maktoum",    # для карты 7
    "Al-Nahyan",     # для карты 8
    "Al-Sheikh",     # для карты 9
    "Al-Dhaheri"     # для карты 10
]

# Массив карт в формате кортежей (номер, срок, CVC)
CARDS = [
    ("5573770014328128", "09/30", "670"),  # карта 1
    ("5573770014346112", "09/30", "553"),  # карта 2
    ("5573770014390037", "09/30", "528"),  # карта 3
    ("5573770015109253", "09/30", "071"),  # карта 4
    ("5573770014305340", "09/30", "282"),  # карта 5
    ("5573770015180304", "09/30", "145"),  # карта 6
    ("5573770014379253", "09/30", "768"),  # карта 7
    ("5573770014376911", "09/30", "399"),  # карта 8
    ("5573770014328573", "09/30", "023"),  # карта 9
    ("5573770014309680", "09/30", "527")   # карта 10
]
...
ADDRESSES = [
    ...
    "Princess--Tower",       # для карты 7
    "Princess++Tower",       # для карты 8
    "Princess==Tower",       # для карты 9
    "Princess^^Tower"        # для карты 10
]
...
ADDRESS_LINE2 = [
    ...
    "42--tier--flat--4208",       # для карты 7
    "42++stage++chamber++4208",   # для карты 8
    "42==platform==space==4208",  # для карты 9
    "42^^level^^quarters^^4208"   # для карты 10
]
...
PHONES = [
    ...
    "542736184",    # для карты 7
    "558947362",    # для карты 8
    "504829517",    # для карты 9
    "562951847"     # для карты 10
]
