...
FIRST_NAMES = [
    ["Omar", "Omer", "Amir"],             # 3 варианта для карты 1
    ["Layla", "Leila", "Laila"],          # 3 варианта для карты 2
    ["Yusuf", "Yousef", "Youssef"]        # 3 варианта для карты 3
]

# Массив фамилий - двумерный: для каждой карты 3 варианта фамилии
LAST_NAMES = [
    ["Al-Rashid", "Al-Rashid", "Al-Rashid"],              # 3 варианта для карты 1
    ["Al-Zahra", "Al-Zahra", "Al-Zahra"],                 # 3 варианта для карты 2
    ["Al-Mansouri", "Al-Mansouri", "Al-Mansouri"]         # 3 варианта для карты 3
]

# Массив карт в формате кортежей (номер, срок, CVC)
CARDS = [
    ("5573770014240307", "09/30", "653"),
    ("5573770014274454", "09/30", "190"),
    ("5573770014260685", "09/30", "680")
]
...
ADDRESSES = [
    ...
    ["Princess*Tower", "Princess+Tower", "Princess=Tower"],                            # 3 варианта для карты 2
...
PHONES = [
    ["552847639", "505691273", "506284951"],                                           # 3 варианта для карты 1
    ["542736184", "558947362", "504829517"],                                           # 3 варианта для карты 2
    ["562951847", "502673819", "544758263"]                                            # 3 варианта для карты 3
]
